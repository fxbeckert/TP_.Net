...
namespace WebServiceConsumer.myWebServiceReference {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="WebServiceHelloWorldSoap", Namespace="http://tempuri.org/")]
    public partial class WebServiceHelloWorld : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public WebServiceHelloWorld() {
            this.Url = global::WebServiceConsumer.Properties.Settings.Default.WebServiceConsumer_myWebServiceReference_WebServiceHelloWorld;
        ...
        /// <remarks/>
        public void AddAsync(int p1, int p2) {
            this.AddAsync(p1, p2, null);
        }
        
        /// <remarks/>
        public void AddAsync(int p1, int p2, object userState) {
            if ((this.AddOperationCompleted == null)) {
                this.AddOperationCompleted = new System.Threading.SendOrPostCallback(this.OnAddOperationCompleted);
            }
            this.InvokeAsync("Add", new object[] {
                        p1,
                        p2}, this.AddOperationCompleted, userState);
        }
